...
<main class="page-delivery">
    ...
    <section class="page-delivery__info">
        ...
        <ul class="page-delivery__list">
            <li>
                <b class="page-delivery__item-title">Стандартная доставка - <?= EXTRA_PRICE_FOR_DELIVERY ?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?= MINIMUM_PRICE_FOR_FREE_DELIVERY ?>  РУБ)</b>
            ...
            <li>
                <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?= EXTRA_PRICE_FOR_DELIVERY ?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?= MINIMUM_PRICE_FOR_FREE_DELIVERY ?>  РУБ)</b>
                <p class="page-delivery__item-desc">
